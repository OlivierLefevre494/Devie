  ...
  <body>
    ...
    <main id="mainpage" class="mainpage" onscroll="onscrollfunction()">
      ...
      <div class="search-bar" id="search-bar">
        ...
        <input class="searchbarcreator" id="search-space-creator" type="text" name="Search" onkeypress="return detect_search(event)" placeholder="Search for a creator">

        <div class="container">
          <div class="tag-container autocomplete" id="tagcontainerdisplay">
    <input id="myInput" type="text" name="myCountry" placeholder="Enter tags here">
  </div>
        </div>

        <button class="search-button" type="button" name="button" onclick="gamesearch()">Search</button>
    </div>
